<kbd><img src="./RedstonePowerDisplay/pack.png" alt="resource pack icon"></img></kbd>
...
one that displays `0` when the redstone signal strength is 0, and one that does not display `0`.
